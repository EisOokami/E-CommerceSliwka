...
import { AuthInputProps } from "./AuthInput.interfaces";
...
export default function AuthInput({
    ...
    return (
        <div className={twMerge(`relative ${containerClassName}`)}>
            <input
                className={twMerge(
                    `w-full px-4 pt-5 pb-4 pr-11 text-gray-700 border rounded-lg appearance-none leading-tight focus:outline-none peer ${inputClassName}`,
                )}
                id={id}
                name={name}
