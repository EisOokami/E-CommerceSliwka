...
export interface ApiAuthPageAuthPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<['layout.sign-in', 'layout.sign-up']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    detailedSpecifications: Schema.Attribute.Component<
      ...
      true
    >;
    discountedPrice: Schema.Attribute.Float;
    ...
    productInfo: Schema.Attribute.Component<'components.product-info', false>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wishlist: Schema.Attribute.Relation<'oneToMany', 'api::wishlist.wishlist'>;
  };
}
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    lastEdited: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::review.review'
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    agreeToTermsAndPrivacy: Schema.Attribute.Boolean;
    ...
    productsCart: Schema.Attribute.Relation<'oneToMany', 'api::cart.cart'>;
